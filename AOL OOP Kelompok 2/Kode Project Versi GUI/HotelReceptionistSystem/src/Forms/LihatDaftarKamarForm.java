...
public class LihatDaftarKamarForm {
	...
	private void SetupTable() {
		...
		tableDaftarKamar.setFillsViewportHeight(true);
		...
		tableDaftarKamar.setAutoCreateRowSorter(true);
	...
	private void LoadData() {
		...
		for (Room room : roomsData) {
			tableModel.addRow(new Object[] { room.getRoomType().getName(), room.getRoomNumber(), room.getRoomType().getPricePerNight(), room.isFilled() ? "Penuh" : "Tersedia" });
		}
